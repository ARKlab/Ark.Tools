...
namespace Ark.Tools.FtpClient
{
    ...
    public interface IFtpClient
    {
        ...
        Task<byte[]> DownloadFileAsync(string path, CancellationToken ctk = default(CancellationToken));
        ...
        /// <param name="ctk"></param>
        Task UploadFileAsync(string path, byte[] content, CancellationToken ctk = default(CancellationToken));
        ...
        Task<IEnumerable<FtpEntry>> ListDirectoryAsync(string path = null, CancellationToken ctk = default(CancellationToken));
        ...
        Task<IEnumerable<FtpEntry>> ListFilesRecursiveAsync(string startPath = null, Predicate<FtpEntry> skipFolder = null, CancellationToken ctk = default(CancellationToken));
    }
}