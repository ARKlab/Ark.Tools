...
namespace Ark.Tools.Outbox
{
    ...
    public interface IOutboxContextAsync : IContextAsync
    {
        ...
        Task SendAsync(IEnumerable<OutboxMessage> messages, CancellationToken ctk = default);
        ...
        Task<IEnumerable<OutboxMessage>> PeekLockMessagesAsync(int messageCount = 10, CancellationToken ctk = default);
        ...
        /// </summary>
        /// <param name="ctk"></param>
        Task<int> ClearAsync(CancellationToken ctk = default);
    }
}
