...
{
    public class RECDataContextFactory1 : AbstractContextFactory1, IContextFactory<IRECDataContext>, IAsyncDisposable
    {
        ...
        public async ValueTask<IRECDataContext> CreateAsync(System.Data.IsolationLevel isolationLevel, CancellationToken cancellationToken)
        {
            ...
            if (Connection != null)
            {
                var recContext = new RECDataContext_Sql(_contextConfig, connection: Connection, isolationLevel);
