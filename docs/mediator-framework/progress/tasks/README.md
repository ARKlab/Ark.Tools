...
| Task | Title | Status |
| --- | --- | --- |
| [SEC-01](security/SEC-01-secure-by-default-endpoints.md) | Secure-by-default generated endpoints | Complete |
...
| [AZM-12](azure-functions/AZM-12-resource-lifecycle.md) | Concurrency-safe Service Bus resource lifecycle | Complete |
| [AZM-13](azure-functions/AZM-13-package-and-composition.md) | Functions messaging package and composition | Complete |
...
| [AZM-17](azure-functions/AZM-17-logical-names-and-native-entity-mapping.md) | Logical names and native entity mapping | Complete |
| [AZM-18](azure-functions/AZM-18-transport-contract-and-payload-sizing.md) | Transport contract and payload sizing | Complete |
...
| Task | Title | Status |
| --- | --- | --- |
| [AMF-01](messaging/AMF-01-receive-seam-split.md) | Receive seam split: message source and native processor | Pending |
...
| [AMF-07](messaging/AMF-07-service-bus-native-processor.md) | Service Bus native processor and pull batch path | Pending |
