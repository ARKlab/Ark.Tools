...
| [AZM-17](azure-functions/AZM-17-logical-names-and-native-entity-mapping.md) | Logical names and native entity mapping | Pending |
| [AZM-18](azure-functions/AZM-18-transport-contract-and-servicebus-topology.md) | Transport contract and Service Bus topology | Pending |
| [AZM-19](azure-functions/AZM-19-non-json-contract-validation.md) | Non-JSON messaging contract validation | Pending |
