...
|---|---|---|
| [AZF-01](azure-functions/AZF-01-foundation.md) | Package and shared HTTP model foundation | AZD-01, AZD-02, AZD-09, AZD-10, AZD-11 |
...
| [AZF-09](azure-functions/AZF-09-openapi.md) | Versioned OpenAPI | AZF-08, AZD-05, AZD-11 |
| [AZF-10](azure-functions/AZF-10-boundary-parity.md) | Core Tools tests, parity matrix and guide | AZF-08, AZF-09, AZD-10, AZD-11 |

### Recommended Azure Functions execution order

1. [x] Resolve AZD-01 through AZD-09 in the decision log.
2. [ ] Resolve AZD-10 and AZD-11.
3. [ ] AZF-01 → AZF-02 → AZF-03.
4. [ ] AZF-04 → AZF-05.
