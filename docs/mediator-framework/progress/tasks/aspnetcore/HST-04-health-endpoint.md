...
- [ ] Path and response shape preserve the existing `/healthCheck` contract.
- [ ] Default registration contains no UI or history support.
- [ ] Responses disclose no secrets or exception details.
