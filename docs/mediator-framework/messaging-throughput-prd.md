...
| --- | --- | --- |
| [`AMF-01`](progress/tasks/messaging/AMF-01-receive-seam-split.md) | Send/receive seam split: `IMessagingMessageSource`, `MessagingReceiverCapabilities`, delivery `LockedUntil`/`DeliveryId`; old receive seam removed | — |
