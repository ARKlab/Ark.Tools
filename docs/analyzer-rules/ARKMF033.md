# ARKMF033: Multiple Functions messaging hosts

- **Severity:** Error
- **Component:** Mediator Framework
- **Diagnostic message:** `An Azure Functions app can bind exactly one messaging participant`
...
Use the standard `dotnet_diagnostic.ARKMF033.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMF033.md`.
