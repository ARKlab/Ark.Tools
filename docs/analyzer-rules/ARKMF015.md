# ARKMF015: Conflicting Rebus owner queue

- **Severity:** Error
- **Component:** Mediator Framework
- **Diagnostic message:** `Rebus contract '{0}' has conflicting owner queues: '{1}' and '{2}'`
...
Use the standard `dotnet_diagnostic.ARKMF015.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMF015.md`.
