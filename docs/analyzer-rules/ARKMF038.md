# ARKMF038: Functions messaging trigger binding is not implemented

- **Severity:** Error
- **Component:** Mediator Framework
- **Diagnostic message:** `Trigger binding value '{0}' is not supported by this generator version`
...
Use the standard `dotnet_diagnostic.ARKMF038.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMF038.md`.
