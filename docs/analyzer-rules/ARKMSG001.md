...
- **Diagnostic message:** `Network '{0}' lists participant '{1}' more than once`
...
Use the standard `dotnet_diagnostic.ARKMSG001.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG001.md`.
