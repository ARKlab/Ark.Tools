...
- **Diagnostic message:** `Participant '{0}' has DefaultSerializer '{1}' outside its Serializers set`
...
Use the standard `dotnet_diagnostic.ARKMSG010.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG010.md`.
