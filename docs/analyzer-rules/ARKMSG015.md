...
- **Diagnostic message:** `Participant '{0}' uses reserved identity '{1}'`
...
Use the standard `dotnet_diagnostic.ARKMSG015.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG015.md`.
