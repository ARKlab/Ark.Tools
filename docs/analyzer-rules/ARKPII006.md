...
- **Diagnostic message:** `Test data contains a plausible {0}; repository clones and CI logs retain it. Replace it with reserved test data.`
...
Use the standard `dotnet_diagnostic.ARKPII006.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKPII006.md`.
