...
- **Diagnostic message:** `Messaging contract name '{0}' is used by more than one contract`
...
Use the standard `dotnet_diagnostic.ARKMSG020.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG020.md`.
