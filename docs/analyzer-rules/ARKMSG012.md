...
- **Diagnostic message:** `Contract '{0}' is declared by participants in more than one messaging network`
...
Use the standard `dotnet_diagnostic.ARKMSG012.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG012.md`.
