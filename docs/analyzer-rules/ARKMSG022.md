...
- **Diagnostic message:** `Messaging contract alias '{0}' collides with a current contract name`
...
Use the standard `dotnet_diagnostic.ARKMSG022.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG022.md`.
