# ARKMF034: Invalid Functions messaging participant

- **Severity:** Error
- **Component:** Mediator Framework
- **Diagnostic message:** `Type '{0}' is not marked with MessagingParticipant`
...
Use the standard `dotnet_diagnostic.ARKMF034.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMF034.md`.
