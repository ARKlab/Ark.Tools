...
- **Diagnostic message:** `Participant '{0}' does not support effective protocol '{3}' of publisher '{1}' for event '{2}'`
...
Use the standard `dotnet_diagnostic.ARKMSG009.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMSG009.md`.
