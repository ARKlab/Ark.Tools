# ARKMF054: Add the MCP contract constructor

- **Severity:** Error
- **Component:** Mediator Framework
- **Diagnostic message:** `MCP contract '{0}' must declare a constructor matching its input members`
...
Use the standard `dotnet_diagnostic.ARKMF054.severity` EditorConfig setting only for an intentional exception. Prefer a documented, reviewed suppression over disabling the rule globally.

## Source

This rule is implemented in Ark.Tools and its descriptor links here: `https://github.com/ARKlab/Ark.Tools/blob/master/docs/analyzer-rules/ARKMF054.md`.
