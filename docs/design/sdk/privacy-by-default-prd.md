...
the [SDK task board](../../plans/sdk/tasks/README.md#compliance-privacy-by-default).
...
[`progress/future-improvements.md`](../../plans/sdk/future-improvements.md). Until
...
[`plans/sdk/tasks/compliance/`](../../plans/sdk/tasks/compliance/), following the same
...
| --- | --- | --- |
| [PII-IMP-01](../../plans/sdk/tasks/compliance/PII-IMP-01-compliance-foundation.md) | `Ark.Tools.Compliance` attributes, taxonomy, redactors, `CompliancePurpose` | §6.1, §17 PII‑01 |
| [PII-IMP-02](../../plans/sdk/tasks/compliance/PII-IMP-02-sensitive-value-object-generator.md) | Value-object generator, redacted surfaces, STJ/Dapper/`TypeConverter` | §6.2, §14 |
| [PII-IMP-03](../../plans/sdk/tasks/compliance/PII-IMP-03-serialization-targets.md) | Newtonsoft, protobuf-net, MessagePack, OpenAPI/Swashbuckle, Reqnroll targets | §6.2, §6.5 |
| [PII-IMP-04](../../plans/sdk/tasks/compliance/PII-IMP-04-declaration-tier-analyzers.md) | `ARKPII001/008/009/010` + code fixes + `ComplianceLexicon.Ark.txt` | §6.1, §6.8, §7, §8 |
| [PII-IMP-05](../../plans/sdk/tasks/compliance/PII-IMP-05-sink-tier-analyzers.md) | `ARKPII002/003/004/005/011` + `ComplianceSinks.Ark.txt` | §6.3, §6.4, §7, §8 |
| [PII-IMP-06](../../plans/sdk/tasks/compliance/PII-IMP-06-compliance-surface-gate.md) | `ArkComplianceSurface.txt` generator + `ARKPII020/021` | §6.10, §17 PII‑04 |
| [PII-IMP-07](../../plans/sdk/tasks/compliance/PII-IMP-07-runtime-redaction.md) | NLog pipeline on by default + OTel processor | §6.9, §17 PII‑06 |
| [PII-IMP-08](../../plans/sdk/tasks/compliance/PII-IMP-08-sql-policy-generation.md) | `[SqlDataPolicy]`/`[SqlColumnPolicy]`, `ARKPII007/012`, template script | §6.6, §17 PII‑05 |
| [PII-IMP-09](../../plans/sdk/tasks/compliance/PII-IMP-09-test-data-rules.md) | `ARKPII006` + `Ark.Tools.Reqnroll` fakes | §6.7 |
| [PII-IMP-10](../../plans/sdk/tasks/compliance/PII-IMP-10-sdk-wiring-and-loggen-guards.md) | SDK wiring, `ArkComplianceMode`, `LOGGEN*` escalation, `AddArkRedaction()`, `ARKPII013`, docs | §9, §10, §13.3 |
| [PII-IMP-11](../../plans/sdk/tasks/compliance/PII-IMP-11-reference-project-adoption.md) | Reference-project adoption, end-to-end and AoT tests | §11, §12 |

Deliberately **not** tasks, recorded as drafts in
[`progress/future-improvements.md`](../../plans/sdk/future-improvements.md): the
...
- [`progress/decisions.md`](../../plans/sdk/decisions.md) — `SDK-20`/`SDK-21`/`SDK-24` analyzer and banned-API policy.
