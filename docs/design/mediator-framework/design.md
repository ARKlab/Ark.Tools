...
[`Azure Functions decision log`](../../plans/mediator-framework/azure-functions-decision-log.md).
...
`docs/mediator-framework/`: a getting-started walkthrough (first contract,
