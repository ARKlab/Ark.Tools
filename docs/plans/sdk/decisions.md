...
- Accepted decisions are recorded in
  [`../design.md`](../../design/sdk/design.md#accepted-decisions); reopen one only with a new
  constraint.
...
[`../design.md`](../../design/sdk/design.md#propagation-limits).
...
[`../design.md`](../../design/sdk/design.md#selected-public-transitive-baseline).
...
recorded once, in
[`../privacy-by-default-prd.md`](../../design/sdk/privacy-by-default-prd.md#17-decisions), and
