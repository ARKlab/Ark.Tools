...
**Design**: [Declaring personal data](../../../../design/sdk/privacy-by-default-prd.md#61-declaring-personal-data),
[Diagnostics](../../../../design/sdk/privacy-by-default-prd.md#7-diagnostics),
[Analyzer implementation strategy](../../../../design/sdk/privacy-by-default-prd.md#8-analyzer-implementation-strategy)
...
- **`ARKPII010`** (error): a classification attribute sits on a member the
  ...
  the exact option to change; see PRD [§14.5](../../../../design/sdk/privacy-by-default-prd.md#145-interop-not-exclusion).
