...
**Design**: [Analyzer and configuration assets](../../../design/sdk/design.md#analyzer-and-configuration-assets),
[Configuration layering](../../../design/sdk/design.md#configuration-layering)
...
- **Canonical assets**: keep the root `.editorconfig` as the canonical
  ...
  `BannedSymbols.Ark.txt` under `src/sdk/Ark.Tools.Build/configuration/`; add the
...
- **Inputs**: add packaged files through `EditorConfigFiles`,
  ...
  `BannedSymbols.Ark.txt` and is recognized by the analyzer through the
