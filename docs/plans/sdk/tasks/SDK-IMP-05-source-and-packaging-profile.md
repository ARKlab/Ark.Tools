...
**Design**: [SDK-only boundary](../../../design/sdk/design.md#kept-in-arktoolssdk-not-public-transitively),
[Late items and targets](../../../design/sdk/design.md#late-items-and-targets)
