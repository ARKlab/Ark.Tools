...
1. Record the accepted D1–D7 decisions from
   `docs/plans/mediator-framework/mediator-testing-decisions.md`.
2. Add a testing-redesign workstream to
   `docs/plans/mediator-framework/tasks/README.md` with links to one task
   document per implementation task.
3. Mark the old T9.8 boundary-test wording in
   `docs/plans/mediator-framework/tasks.md` as superseded by this workstream;
