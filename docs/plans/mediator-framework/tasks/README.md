...
[`../azure-functions-design.md`](../../../design/mediator-framework/azure-functions-design.md) and
...
The design baseline is
[`../../messaging-throughput-prd.md`](../../../design/mediator-framework/messaging-throughput-prd.md).
