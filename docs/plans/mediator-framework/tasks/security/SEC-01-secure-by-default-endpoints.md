...
4. Update docs: `docs/design/mediator-framework/design.md` (endpoint mapping section) and `docs/mediator-framework/migration-from-mvc.md` (the "keep authorization metadata" claim now has a concrete mechanism).
