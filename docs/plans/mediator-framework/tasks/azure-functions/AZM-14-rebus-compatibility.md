...
9. Register a Rebus `IBus` adapter that proxies `Send`, `Defer`,
...
Update [`guide/rebus.md`](../../../../mediator-framework/rebus.md),
[`guide/azure-functions.md`](../../../../mediator-framework/azure-functions.md), and
[`guide/host-setup-and-composition.md`](../../../../mediator-framework/host-setup-and-composition.md)
