...
**Depends on**: AMF-02
**Scope**: FRAMEWORK
**Design**: [Lock renewal](../../../../design/mediator-framework/messaging-throughput-prd.md#65-lock-renewal), [Prefetch budget](../../../../design/mediator-framework/messaging-throughput-prd.md#63-prefetch-budget)
