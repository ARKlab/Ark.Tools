...
**Scope**: FRAMEWORK
**Design**: [Solution shape](../../../../design/mediator-framework/messaging-throughput-prd.md#5-solution-shape), [Breaking changes](../../../../design/mediator-framework/messaging-throughput-prd.md#11-breaking-changes)
...
- **No push seam**: every transport is a pull source. Azure Functions receivers
  ...
  ([why](../../../../design/mediator-framework/messaging-throughput-prd.md#154-rejected-servicebusprocessor-as-the-service-bus-pump)).
