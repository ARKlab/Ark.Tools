...
**Scope**: FRAMEWORK
**Design**: [Transport profiles](../../../../design/mediator-framework/messaging-throughput-prd.md#7-transport-profiles), [Provider facts](../../../../design/mediator-framework/messaging-throughput-prd.md#44-provider-facts-that-constrain-the-design)
