...
**Depends on**: AMF-01
**Scope**: FRAMEWORK
**Design**: [Processor host runtime](../../../../design/mediator-framework/messaging-throughput-prd.md#6-processor-host-runtime), [Prefetch budget](../../../../design/mediator-framework/messaging-throughput-prd.md#63-prefetch-budget)
