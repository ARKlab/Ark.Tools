...
| Azure Functions hosting | [`azure-functions-decision-log.md`](azure-functions-decision-log.md), [`../azure-functions-design.md`](../../design/mediator-framework/azure-functions-design.md) | `tasks/azure-functions/AZF-*.md` |
...
- Behavior changes update [`../design.md`](../../design/mediator-framework/design.md) in the same change.
