...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ODataSample.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ODataSample.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.OwnsOne("ODataSample.Models.Address", "Location", b1 =>
                        {
                            ...
                            b1.HasOne("ODataSample.Models.Book")
                                .WithOne("Location")
                                .HasForeignKey("ODataSample.Models.Address", "Id")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("ODataSample.Models.City", b =>
                {
                    b.HasOne("ODataSample.Models.Country")
                        .WithMany("Cities")
