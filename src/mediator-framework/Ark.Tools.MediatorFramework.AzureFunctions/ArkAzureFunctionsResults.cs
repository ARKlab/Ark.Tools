...
public static class ArkAzureFunctionsResults
{
    ...
    public static IResult? ApplyResponseETag(HttpContext context, [NotPersonalData("Opaque ETag is a non-personal concurrency token.")] string? token, bool conditionalGet)
    {
        ArgumentNullException.ThrowIfNull(context);
