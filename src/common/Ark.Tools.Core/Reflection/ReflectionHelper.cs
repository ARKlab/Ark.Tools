...
/// <summary>
/// Reflection utilities that require unreferenced code.
...
public static class ReflectionHelper
{
    ...
    /// <returns></returns>
    [RequiresUnreferencedCode("Uses reflection to inspect type interfaces. Interface types may be trimmed if not explicitly referenced.")]
    public static Type? GetEnumerableItemType([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] Type type)
    {
    ...
    [RequiresUnreferencedCode("Uses reflection to access fields and properties by name. Members may be trimmed if not explicitly referenced.")]
    ...
    /// <returns></returns>
    [RequiresUnreferencedCode("Uses reflection to inspect type metadata including generic arguments and element types. Type information may be incomplete when trimmed.")]
    ...
    [RequiresUnreferencedCode("Uses reflection to inspect type metadata including generic arguments. Type information may be incomplete when trimmed.")]
