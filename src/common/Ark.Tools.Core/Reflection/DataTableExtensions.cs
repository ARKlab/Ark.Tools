...
/// These methods support derived types but require unreferenced code.
...
public static class ArkDataTableExtensions
{
    ...
    /// This method supports derived types but requires unreferenced code.
    /// </summary>
    ...
    [RequiresUnreferencedCode("This method uses reflection to inspect runtime types including derived types. Properties and fields may be trimmed if not explicitly referenced.")]
