...
public class ZonedDateTimeRangeConverter : JsonConverter
{
    ...
    [UnconditionalSuppressMessage("Trimming", "IL2026:RequiresUnreferencedCode",
        Justification = "The Surrogate type is a private class defined in this converter with only ZonedDateTime properties. NodaTime types are explicitly supported by NodaTime.Serialization.JsonNet and will not be trimmed.")]
