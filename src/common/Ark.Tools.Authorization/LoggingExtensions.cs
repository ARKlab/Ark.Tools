...
internal static partial class LoggingExtensions
{
    ...
    {
        logger.Trace(global::System.Globalization.CultureInfo.InvariantCulture, "Authorization for policy {PolicyName} succeded for user {Username}.", policyName, username);
    }
