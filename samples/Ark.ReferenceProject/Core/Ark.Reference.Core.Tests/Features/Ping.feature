...
## Endpoint ##################################################################################################
  ...
  Scenario: Endpoint Ping Create and Get
  ...
  Scenario: Endpoint Ping Get by filters
  ...
  Scenario: Endpoint Ping Patch 404
    When I try to update using 'PATCH' a Ping with
      | Id | Name        | Type  |
      |  0 | PingNewName | Ping2 |
    Then the request fails with 404

  Scenario: Endpoint Ping Delete
    When I create multiple Ping with
      | Name  | Type  |
      | PingA | Ping1 |
      | PingB | Ping2 |
  ...
  Scenario: Endpoint Ping Create and SendMsg
  ...
  Scenario: Endpoint Ping Create and SendMsg Fails
    When I create a single Ping And SendMsg with
      | Name      | Type  |
      | PingFails | Ping1 |
    Then the request succeded
  ...
  Scenario: Endpoint Ping Create and SendMsg FastFails
    When I create a single Ping And SendMsg with
      | Name          | Type  |
      | PingFailsFast | Ping1 |
    Then the request succeded
...
### Audit ##################################################################################################
  ...
  Scenario: Audit Check Ping Create
    When I create a single Ping with
      | Name      | Type  |
      | AuditPing | Ping1 |
    Then the request succeded
  ...
  Scenario: Audit Check Ping UpdatePut
    When I create a single Ping with
      | Name      | Type  |
      | AuditPing | Ping1 |
    Then the request succeded
  ...
  Scenario: Audit Check Ping UpdatePatch
    When I create a single Ping with
      | Name      | Type  |
      | AuditPing | Ping1 |
    Then the request succeded
...
## Validator ##################################################################################################
  ...
  Scenario: Validator Ping Create fails for no type provided
    When I create a single Ping with
      | Name      | Type |
      | PingName1 |      |
    Then the request fails with 400

  Scenario: Validator Ping Create fails for no name provided
    When I create a single Ping with
      | Name | Type  |
      |      | Ping1 |
    Then the request fails with 400

  Scenario: Validator Ping Create fails for name too long
    When I create a single Ping with
      | Name                                                        | Type  |
      | AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA | Ping1 |
    Then the request fails with 400

  Scenario: Validator Ping by Name fails
    Given I make a request to 'FAIL' ping
    Then the request fails with 400

  Scenario: Validator Ping by Name fails because the min length
