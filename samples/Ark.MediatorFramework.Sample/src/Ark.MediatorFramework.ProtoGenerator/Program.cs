...
schema.AppendLine("message ArkBusinessRuleViolation { string type = 1; string title = 2; int32 status = 3; string detail = 4; string instance = 5; map<string, string> extensions = 6; }");
schema.AppendLine();
