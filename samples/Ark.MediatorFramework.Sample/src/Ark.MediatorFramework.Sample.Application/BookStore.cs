...
public interface IBookStore
{
    ...
    Task<BookResponse> CreateAsync(BookResponse book, CancellationToken ctk = default);
    ...
    Task<BookResponse> UpdateAsync(BookResponse book, CancellationToken ctk = default);

    /// <summary>Deletes a book.</summary>
    Task DeleteAsync(Guid id, CancellationToken ctk = default);
...
public sealed class InMemoryBookStore : IBookStore
{
    ...
    /// <inheritdoc />
    public Task<BookResponse> CreateAsync(BookResponse book, CancellationToken ctk = default)
    {
    ...
    /// <inheritdoc />
    public Task<BookResponse> UpdateAsync(BookResponse book, CancellationToken ctk = default)
    {
        ArgumentNullException.ThrowIfNull(book);
    ...
    /// <inheritdoc />
    public Task DeleteAsync(Guid id, CancellationToken ctk = default)
    {
